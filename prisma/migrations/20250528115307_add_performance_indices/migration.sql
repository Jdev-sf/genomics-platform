-- Sostituisci il contenuto della migrazione con questo SQL semplificato
...
-- 6. Index for gene position range queries (simplified)
...
-- 9. Index for session management (simplified)
CREATE INDEX IF NOT EXISTS "idx_sessions_user_expires" 
ON "sessions" ("user_id", "expires_at");

-- 10. Index for active user sessions (simplified)
...
-- 12. Index for variant frequency filters (simplified)
...
-- 15. Composite index for user role permissions (simplified)
